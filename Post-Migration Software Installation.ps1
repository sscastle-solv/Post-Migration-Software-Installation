...
$defaultApps = @(
    ...
    @{ Name = "Splunk"; FilePath = "\\awsuse2file01.3mhealth.com\bedrock\Installs\Agents\Splunkmsiexec.exe"; Arguments = msiexec /i [ArgumentCompleter({
        ...
        "\\awsuse2file01.3mhealth.com\Installs\Splunk\splunkforwarder-9.2.1-78803f08aabb-x64-release.msi"
        
        return $CompletionResults
    })] /qn AGREETOLICENSE=Yes RECEIVING_INDEXER="3mhealth.splunkcloud.com:9997" DEPLOYMENT_SERVER="splunkcloudprufds.3mhealth.com:8089" SPLUNKUSERNAME="splunkadmin" SPLUNKPASSWORD="qfZB-YwWTpafQP!X!-9BJFZ3jvshEFYg" },
