...
$defaultApps = @(
    ...
    @{ Name = "Splunk"; FilePath = "msiexec.exe"; Arguments = '/i "\\awsuse2file01.3mhealth.com\bedrock\Installs\Agents\Splunk\splunkforwarder-9.2.1-78803f08aabb-x64-release.msi" /qn AGREETOLICENSE=Yes RECEIVING_INDEXER="3mhealth.splunkcloud.com:9997" DEPLOYMENT_SERVER="splunkcloudprufds.3mhealth.com:8089" SPLUNKUSERNAME=splunkadmin SPLUNKPASSWORD=qfZB-YwWTpafQP!X!-9BJFZ3jvshEFYg' },
    @{ Name = "Qualys"; FilePath = "\\awsuse2file01.3mhealth.com\bedrock\Installs\Agents\Qualys\QualysCloudAgent.exe"; Arguments = "CustomerId={6ee5d733-9e25-7597-8254-c36cfcfb4bed} ActivationId={a8e88c2c-9361-406c-8fc9-cefd8cdabc40} WebServiceUri=https://qagpublic.qg2.apps.qualys.com/CloudAgent/" },
    @{ Name = "SCCM"; FilePath = "\\awsuse2file01.3mhealth.com\bedrock\Installs\Agents\SCCM Client\Client\ccmsetup.exe"; Arguments = "/mp:https://MECMPRDPR3SEC1.3mhealth.com /skipprereq:silverlight.exe /forceinstall SMSSITECODE=PRH SMSMP=MECMPRDPR3SEC1.3mhealth.com FSP=MECMPRDPR3.3mhealth.com /UsePKICert /NoCRLCheck" }
)
